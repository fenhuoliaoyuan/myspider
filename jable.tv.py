...
if __name__ == '__main__':
    ...
    path_name = r'E:\番号\JUFE-250 爆乳姐誘惑童貞弟 卻反過來被肏翻！深田詠美.ts'
    if not os.path.exists(path_name):
        list_ts_file = ''
        url_m3u8= 'https://honey-idad.alonestreaming.com/hls/Yfy2yBuho4NJPDJQA_n7Ig/1638209527/12000/12889/12889.m3u8'
