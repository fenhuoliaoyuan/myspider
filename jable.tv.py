...
if __name__ == '__main__':
    ...
    path_name = r'E:\番号\SSIS-252 河北彩花10変化 極上オナニーサポート 河北彩花.ts'
    if not os.path.exists(path_name):
        list_ts_file = ''
        url_m3u8= 'https://amuse-lefty.mushroomtrack.com/hls/AIuQ3g0DFaNlN7oawoLQqw/1637693834/20000/20016/20016.m3u8'
