...
if not os.path.exists('./番号预览_FALENO/'):  # 创建文件目录
    os.mkdir('./番号预览_FALENO/')
for page in range(1,8):
    print('==========================================第{}页下载开始=========================================='.format(page))
    URL = 'https://javdb6.com/makers/Y46?f=preview&page={}'.format(page)
    ...
    if session:
        ...
        for div in div_list:
            ...
            path_video = './番号预览_FALENO/' + name_video + '.mp4'
