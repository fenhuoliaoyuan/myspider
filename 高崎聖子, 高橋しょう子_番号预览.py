...
if not os.path.exists('C:/番号/沖田杏梨番号预览/'):  # 创建文件目录
    os.mkdir('C:/番号/沖田杏梨番号预览/')

# for page in range(1,5):
def main(page):
    print('==========================================第{}页下载开始=========================================='.format(page))
    URL = 'https://javdb6.com/actors/pDeZ?page={}&t=s'.format(page)
    ...
    if session:
        ...
        for div in div_list:
            ...
            path_video = 'C:/番号/沖田杏梨番号预览/' + name_video + '_' + datetime + '.mp4'
                ...
                try:
                    ...
                    try:
                        ...
                        with open(path_video, 'wb') as fp:
                            fp.write(video)
                            print('视频{}.mp4下载成功-----------第{}页'.format(name_video+'_'+datetime,page))
    else:
        print('没有cookie')
